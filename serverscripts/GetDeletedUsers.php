...
if (validateInputData(array('SessionId', 'ItemsOnPage', 'PageNumber'))) {
	if (validateSession(null) && connectToDatabase()) {
		...
		$result1         = mysql_query('SELECT COUNT(*) AS Records FROM Users Where IsDeleted = 1');
		...
		$result2 = mysql_query("SELECT Id, FullName, Email, UserName, Phone, LastAccess From Users Where IsDeleted = 1 LIMIT $startRecord, $itemsOnPage");
